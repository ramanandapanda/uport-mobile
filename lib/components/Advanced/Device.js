...
class Device extends React.Component {
  ...
  render() {
    return (
      <Menu>
        <MenuItem title='Device Address' value={abbr(this.props.deviceAddress)} href={`${this.props.explorerUrl}/address/${this.props.deviceAddress}`} />
        <MenuItem title='Device Gas' value={wei2eth(this.props.fuel || 0) + ' ETH'} working={this.props.workingFuel} />
        <MenuItem title='Device Nonce' value={this.props.nonce || 0} working={this.props.workingNonce} last />
      </Menu>
    )
  } 
}
