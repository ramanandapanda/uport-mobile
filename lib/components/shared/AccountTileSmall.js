...
const AccountTileSmall = (props) => {
  return (
    <View elevation={10} style={styles.container}>
      <Avatar size={windowWidth * 0.13} borderColor={colors.white246} source={props.accountProfile || {avatar: require('uPortMobile/assets/images/eth-symbol2.png')}} initialsStyle={{fontSize: 36}} />
