  ...
  return (
    <View elevation={10} style={styles.container}>
      ...
      <View style={styles.tileTopHalf}>
        <Avatar size={windowWidth * 0.16} borderColor={colors.white246} source={props.accountProfile || {avatar: require('uPortMobile/assets/images/eth-symbol2.png')}} initialsStyle={{fontSize: 36}} />
