...
import Verifications from 'uPortMobile/lib/screens/Verifications'
import VerificationScreen from 'uPortMobile/lib/screens/Verification'
...
import BlankScreen from 'uPortMobile/lib/screens/Blank'
...
export function registerScreens (store, Provider, navigator = Navigation) {
  ...
  /* 
    Modern UI Screens
  */
  navigator.registerComponent('screen.Accounts', () => Accounts, store, Provider )
  navigator.registerComponent('screen.Account', () => Account, store, Provider )
  navigator.registerComponent('screen.Verifications', () => Verifications, store, Provider )
  navigator.registerComponent('screen.VerificationScreen', () => VerificationScreen, store, Provider )
  ...
  navigator.registerComponent('screen.BlankScreen', () => BlankScreen )
  ...
  */
  ...
  navigator.registerComponent('request.transaction', () => require('./components/Request/types/TransactionCard').default, store, Provider)
